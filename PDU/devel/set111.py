...
pMod.apiPDU.setVarBinds(
    ...
    #  ('1.3.6.1.4.1.318.1.1.12.3.3.1.1.4.8', pMod.Integer(int(sys.argv[1]))),
     
#)
      (
      ('1.3.6.1.4.1.318.1.1.12.3.3.1.1.4.'+sys.argv[1], pMod.Integer(action[sys.argv[2]])),
))

# Build message
reqMsg = pMod.Message()
pMod.apiMessage.setDefaults(reqMsg)
pMod.apiMessage.setCommunity(reqMsg, 'observer')
...
transportDispatcher.sendMessage(
    encoder.encode(reqMsg), udp.domainName, ('192.168.1.111', 161)
)
